...
1. **Spec schreiben** -- WAS und WARUM. Speichern unter `docs/specs/<feature>.md`
2. **Plan schreiben** -- WIE und WANN. Speichern unter `docs/specs/<feature>-implementation-plan.md`
